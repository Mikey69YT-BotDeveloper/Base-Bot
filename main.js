...
require("./configuracion-bot.js");
nocache("./configuracion-bot.js", (module) => console.log('\x1b[1;31m', color(`─────────────────────────────────────────────────────────────────────\n`, "magenta"), color("➛ ", "red"), color("Estado: "), color(`${module} Se actualizó!`, "pink")));
...
_*❖* Espero que haya leído las reglas para no tener malos entendidos_`
       ...
       const bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
                ...
                welcomeButt = { contentText: `${teks}`, footerText: `*Copyright © MK-Bot*`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
...
const jam = moment.tz('Europe/Madrid').format('HH:mm:ss')
let d = new Date
let locale = 'es'
